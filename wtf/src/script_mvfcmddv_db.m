...
%    dissimilaridade 100 vezes para obter uma partiï¿½ï¿½o fuzzy em 10 grupos e
%    selecione o melhor resultado segundo a funï¿½ï¿½o objetivo. Para detalhes 
%    do algoritmo "Multi-view relacional fuzzy c-medoids vectors clustering
%    algorithm - MVFCMddV" veja a seï¿½ï¿½o 2 do artigo:
...
% - Para o melhor resultado imprimir: i) a partiï¿½ï¿½o fuzzy (matrix U), ii) a 
%   matriz de pesos iii) a partiï¿½ï¿½o hard (para cada grupo, a lista de 
%   objetos), vi) para cada grupo a lista de medoids, v) 0 ï¿½ndice de Rand 
%   corrigido.
%
