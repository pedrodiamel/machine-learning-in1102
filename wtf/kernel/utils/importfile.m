...
%   MFEATFAC = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   MFEATFAC = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   mfeatfac = importfile('mfeat-fac', 1, 2000);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/05/09 02:38:40
